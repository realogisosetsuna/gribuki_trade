...
| Research | `strategy_lab/exit_evaluator.py`, `strategy_lab/experiments.py`, `services/adversarial_macro.py` | pure calculations → dataset/manifest IO → orchestration |
...
`src/gribuki_trade/strategy_lab/exit_serialization.py`. Focused verification is
...
`tests/unit/test_strategy_lab_exit_serialization.py`.
