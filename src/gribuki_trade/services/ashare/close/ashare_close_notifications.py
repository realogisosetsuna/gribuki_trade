...
from gribuki_trade.services.ashare.close import (
    ashare_close_notification_splitting as _notification_splitting,
)
...
from gribuki_trade.services.macro.macro_models import EvidenceSelection

# 保留历史私有函数名称，调用方和盘后服务无需在同一提交中迁移。
_split_contractual_instrument_report = (
    _notification_splitting._split_contractual_instrument_report
)
_split_plain_text_payload = _notification_splitting._split_plain_text_payload
_dual_track_report_lines = _notification_splitting._dual_track_report_lines
_split_notification_text = _notification_splitting._split_notification_text
