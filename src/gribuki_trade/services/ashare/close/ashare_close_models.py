...
if TYPE_CHECKING:
    ...
    from gribuki_trade.services.macro.global_risk_evidence import GlobalRiskEvidenceBundle
    from gribuki_trade.services.macro.macro_research import EvidenceSelection
    from gribuki_trade.services.macro.official_rates_evidence import OfficialRatesEvidenceBundle
