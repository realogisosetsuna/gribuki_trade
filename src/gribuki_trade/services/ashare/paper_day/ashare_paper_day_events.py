...
from gribuki_trade.services.ashare.paper_day import ashare_paper_day_notifications as _notifications
...
from gribuki_trade.storage.execution.report_artifact_outbox import ReportArtifactStatus
...
def _append_and_sync_text(path: Path, text: str) -> None:
    ...
    from gribuki_trade.services.ashare.paper_day import ashare_paper_day
